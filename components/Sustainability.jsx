...
const sustainabilityItems = [
  { icon: Droplet, title: 'WATER MANAGEMENT', desc: 'Rainwater harvesting, water recycling, and low-flow fixtures help reduce water usage efficiently.' },
  { icon: Zap, title: 'ENERGY EFFICIENCY', desc: 'LED lighting, solar power for common areas, and optimized design ensure lower energy consumption.' },
  { icon: Recycle, title: 'SUSTAINABLE MATERIALS', desc: 'Eco-friendly, low-emission materials and durable finishes support long-term sustainability.' },
]
    ...
    <section id="sustainability" style={{
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-[1100px] relative z-10">
        ...
        <div data-aos="fade-up" data-aos-delay="100" style={{
          ...
          <CurvedCorners color="#dcdfe4" bg="#fff" />
