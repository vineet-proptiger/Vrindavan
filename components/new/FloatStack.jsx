  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[100] flex shadow-[0_-4px_15px_rgba(0,0,0,0.1)] md:hidden">
      <a 
        ...
        className="flex-1 bg-[#111827] text-white py-2.5 flex flex-col items-center justify-center gap-1 hover:bg-[#1f2937] transition-colors"
      >
        <Phone size={20} className="text-white" />
        <span className="text-[12px] font-medium tracking-wide">Call Us</span>
      </a>
      ...
      >
        ...
        <span className="text-[12px] font-bold tracking-wider uppercase">Enquire</span>
      </button>
      
      <a 
        href="https://wa.me/919718344024?text=Hi%20I%20am%20interested%20in%20Hero%20Homes%20Plots%20in%20Vrindavan" 
        target="_blank" 
